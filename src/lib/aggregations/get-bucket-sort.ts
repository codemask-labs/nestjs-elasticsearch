...
// note: all field are optional, because
...
export const getBucketSortAggregation = (paramters: BucketSortAggregationBody): BucketSortAggregation => ({
    bucket_sort: paramters
})
