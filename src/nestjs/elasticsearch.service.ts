...
export class ElasticsearchService {
    ...
    search<TDocument extends Document, TAggregationsBody extends AggregationsBody<TDocument>>(document: ClassConstructor<TDocument>, options?: SearchRequest<TDocument, TAggregationsBody>) {
