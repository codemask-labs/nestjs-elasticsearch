...
export class ElasticsearchService {
    ...
    search<TDocument extends Document, TAggregationsBody extends Record<string, AggregationList<TDocument>>>(document: ClassConstructor<TDocument>, options?: SearchRequest<TDocument, TAggregationsBody>) {
        ...
        return this.elasticsearchBaseService.search<ElasticsearchResult<TDocument, TAggregationsBody>>(request).then(response => getSearchResponse(document, response))
    }
